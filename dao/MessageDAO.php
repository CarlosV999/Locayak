...
class MessageDAO{
    ...
    public static function ajouterMessage($informationMessage)
    {
        ...
        $MESSAGE_SQL_AJOUTER_MESSAGE = "INSERT INTO chat (idUtilisateur,idDestinataire,message,idLocation,date) VALUES (:idUtilisateur,:idDestinataire,:message,:idLocation,:date)";
